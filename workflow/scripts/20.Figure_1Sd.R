# Script to produce figure S1d

# Redirect all R logs to Snakemake log
log <- file('logs/20-Figures/figure1Sd.log', open = "wt")
...
cat("Save plot\n")
svg(paste0(opt$outdir,"/FigS1d.svg"), width=14, height=10)
print(g)
dev.off()

write.csv(correlations, paste0(opt$outdir, "/data/S1d.csv"))
