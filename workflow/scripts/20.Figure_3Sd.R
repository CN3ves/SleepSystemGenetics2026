...
mds <- plotMDS(counts, col =  colors[strains], pch = points, top= round(nrow(counts)*0.1), gene.selection="common", main=paste0("RNA MDS (PCA) using top 10% (", round(nrow(counts)*0.1) ,") variable features"))
