# Script to produce figure 8b

# Redirect all R logs to Snakemake log
log <- file('logs/20-Figures/figure8b.log', open = "wt")
...
keep_phenos <- c('BXDvs1224bsl.rL.D', 'BXDr24bsl.h7')
...
svg(paste0(opt$outdir, "/Fig8b.svg"),width=10,height=10)
